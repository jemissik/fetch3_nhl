...
def test_nhl_standalone_run():
    ...
    from fetch3.nhl_transpiration.main_standalone import run

    run(["--config_path", config_path, "--data_path", data_path, "--species", species_list[0]], standalone_mode=False)
